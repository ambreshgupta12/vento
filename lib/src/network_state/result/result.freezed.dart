...
// ignore: unused_element
  Failure<T> failure<T>({@required ResultError error}) {
    return Failure<T>(
      error: error,
    );
  }
...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult failure(ResultError error),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult success(T data),
    TResult failure(ResultError error),
...
class _$FailureCopyWithImpl<T, $Res> extends _$ResultCopyWithImpl<T, $Res>
  ...
  $Res call({
    ...
    return _then(Failure<T>(
      error: error == freezed ? _value.error : error as ResultError,
    ));
  }
}
...
abstract class Failure<T> implements Result<T> {
  const factory Failure({@required ResultError error}) = _$Failure<T>;
